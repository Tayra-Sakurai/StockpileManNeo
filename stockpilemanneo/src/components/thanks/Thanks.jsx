...
import thanks from "../../assets/dependencies.json" with {
  type: 'json'
};
import ThanksData from "./ThanksData.jsx";
...
function Thanks() {
  return (
    ...
    >
      {Object.entries(thanks).map(([key, value]) => <ThanksData name={key} {...value} />)}
    </Paper>
  );
}
